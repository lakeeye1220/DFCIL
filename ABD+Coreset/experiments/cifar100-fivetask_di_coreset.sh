...
python -u run_dfcil.py --dataset CIFAR100 --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT \
    ...
    --mu 1 --memory 50000 --model_name $MODELNAME --model_type resnet \
    --learner_type kd --learner_name DI_Coreset \
    --overwrite $OVERWRITE --max_task $MAXTASK --log_dir ${OUTDIR}/deepinv_Coreset # --dataroot ../../data/dataset
