...
python3 -u run_dfcil.py --dataset CIFAR100 --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT \
    ...
    --beta 1 --power_iters $PI --deep_inv_params 1e-4 5e1 1e-3 2 1 \
    --overwrite $OVERWRITE --max_task $MAXTASK --log_dir ${OUTDIR}/abd --cgan disc_test
