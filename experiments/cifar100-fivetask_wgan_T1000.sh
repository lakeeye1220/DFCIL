...
# benchmark settings
DATE=WGAN_pseudo_cnt_T1000_CE0.5_TEST_thres0.8
SPLIT=20
...
python3 -u run_dfcil.py --dataset CIFAR100 --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT \
    ...
    --beta 1 --power_iters $PI --deep_inv_params 5e-4 5e1 1e-3 1e3 0.5 \
    --overwrite $OVERWRITE --max_task $MAXTASK --log_dir ${OUTDIR}/abd --cgan wgan --wgan_ce True --gan_target pseudo
