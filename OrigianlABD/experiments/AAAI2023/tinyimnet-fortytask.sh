...
DATE=AAAI2023
SPLIT=5
OUTDIR=outputs/${DATE}/DFCIL-fortytask/TinyImageNet
...
python3 -u run_dfcil.py --dataset TinyImageNet --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT --dataroot $DATAROOT \
    ...
    --ft --balancing -dw_cls --kd_type hkd_yj --middle_kd_type sp --middle_mu 100
# # Full Method
