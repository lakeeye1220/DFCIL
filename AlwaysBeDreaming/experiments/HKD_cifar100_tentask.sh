...
#DATE=ICCV2021
#DATE=ResNet34
DATE=ResNet32_Middle_and_Hard_Distill_divide_10
SPLIT=10
...
# Full Method
CUDA_VISIBLE_DEVICES=3 python3 -u run_dfcil.py --dataset CIFAR100 --train_aug --rand_split --gpuid $GPUID --repeat $REPEAT \
