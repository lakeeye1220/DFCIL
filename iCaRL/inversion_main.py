...
parser.add_argument('--epochs', type=int, default=70, help="traning epochs per each tasks")
...
parser.add_argument('--lr_steps', help='lr decaying epoch determination', default=[48,62],
