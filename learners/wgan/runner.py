...
def main(args):
    ...
    generator = Generator(128,"N/A",32,64,False,["N/A"],"W/O",NUM_CLASSES,"ortho","N/A",False)
    ...
    train_dataloader=torch.utils.data.DataLoader(dataset,batch_size=64,shuffle=True,num_workers=4)
